        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="contributions.jsp"><i class="fa fa-fw fa-check"></i> Approve Contributions</a>
                    </li>
               <!--     <li>
                        <a href="bootstrap-elements.html"><i class="fa fa-fw fa-desktop"></i> Mandatory Courses</a>
                    </li>
                   ...
                   <li>
                        <a href="add courses.jpg"><i class="fa fa-fw fa-file"></i> Add Courses</a>
                    </li>
                   <li>
                        <a href="view users.jpg"><i class="fa fa-fw fa-users"></i> View Users</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
