    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="blog.jsp"><i class="fa fa-fw fa-edit"></i> Blog</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form">
							...
							<label>Name:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<input type="text" value="kk"><br><br>
							<label>Email:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="khh@ghj"><br><br>
							<label>Date of birth:</label> <input type="text" value="11-10-96"><br><br>
							<label>Designation: </label>&nbsp;<input type="text" value="lkjh"><br><br>
							<label>Joining date:</label> <input type="text" value="22-08-13"><br><br>
							<label>Address:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="dsff"><br><br>
							<label>phone:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="123455667"><br><br>
							</fieldset>
                            </div>
                ...
                <!-- /.row -->
				<img src="person.png" alt="face" height="142" width="142">
