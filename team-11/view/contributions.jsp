            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Contributions
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <form method="post" name="UploadServlet" enctype="multipart/form-data" action="http://localhost:9090/Villgro2016/Upload?admin="<%=admin%>>
                        <div class="form-group">
                                <label>Course Name</label>
                                <input type="text" placeholder="Course Name" class="form-control" name="course" ><br>
                                 
                                
						</div>
                           <div class="form-group">
                                <label>Upload notes and get reward</label>
                                <input type="file" class="form-control" name="uploadfile" size="30"><br>
