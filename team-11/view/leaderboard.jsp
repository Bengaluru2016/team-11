    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Battle ground</a>
            </div>
            <!-- Top Menu Items -->
			...
			<div class="col-lg-4">
				<div class="panel panel-success">
					<div class="panel-heading">
						<h3 class="panel-title">Battle ground</h3>
					...
					<div class="panel-body">
					    ...
					    try  
						{
							...
							if(connection!=null)
							{
								...
								query1 = "select * from scores order by score";
								rs = stmt.executeQuery(query1);
									...
									while(rs.next())
									{
										i++;
										out.print("<tr>");
										out.print("<td>" + rs.getString("usernme") + "</td>");
