...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Approve Contradictions
                            </li>
                        </ol>
                    </div>
                </div>
  ...
  <tr>
    <td>Alfred</td>
    <td><a href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_intro">&nbsp;&nbsp;&nbsp;link</a></td>
    <td>&nbsp;&nbsp;&nbsp;<button type="button">Approve</button>&nbsp;&nbsp<button type="button">Disapprove</button></td>
  </tr>
  <tr>
    <td>Richard</td>
    <td><a href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_intro">&nbsp;&nbsp;&nbsp;link</a></td>
